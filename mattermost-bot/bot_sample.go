...
const (
	...
	USER_EMAIL    = "mr_kofi@thinhvoxuan.me"
	USER_PASSWORD = "Password1"
	USER_NAME     = "mr_kofi"
	USER_FIRST    = "Kofi"
	USER_LAST     = "Bot"

	TEAM_NAME        = "thinhvoxuan"
...
func main() {
	...
	client = model.NewAPIv4Client("http://localhost:30001")
	...
	webSocketClient, err := model.NewWebSocketClient4("ws://localhost:30001", client.AuthToken)
	if err != nil {
...
func HandleMsgFromDebuggingChannel(event *model.WebSocketEvent) {
	...
	if post != nil {
		...
		if matched, _ := regexp.MatchString(`(?:^|\W)alive(?:$|\W)`, post.Message); matched {
			SendMsgToDebuggingChannel("Yes I'm running", post.Id, post.ChannelId)
			return
		}
	...
	SendMsgToDebuggingChannel("I did not understand you!", post.Id, post.ChannelId)
}
